...
function deletePortForward(portForward: PortForward) {
  if (
    !confirm(
      `Sei sicuro di voler eliminare il port forwarding ${portForward.dest_ip}:${portForward.dest_port}?`,
    )
  ) {
    return
  }
...
<template>
  <div class="min-h-screen bg-gradient-to-br from-base-100 to-base-200">
    <div class="container mx-auto px-4 py-8">
          ...
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="text-base-content/70">
                Visualizza e gestisci tutti i port forwarding del sistema
              </p>
            </div>
          </div>
      ...
      <div
        class="bg-base-100/80 backdrop-blur-sm border border-base-300/50 rounded-2xl p-4 mb-6 shadow-xl"
      >
      ...
      <!-- Lista Port Forwards -->
      <div
        class="bg-base-100/80 backdrop-blur-sm border border-base-300/50 rounded-2xl shadow-xl overflow-hidden"
      >
