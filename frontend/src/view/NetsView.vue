  ...
  <div class="space-y-8">
      ...
      <div class="liquid-glass-card p-6">
        <div class="flex items-center gap-4">
          <div class="btn btn-warning btn-square btn-lg">
            <IconifyIcon icon="material-symbols:pending" class="text-2xl" />
          </div>
          <div>
      ...
      <div class="liquid-glass-card p-6">
        <div class="flex items-center gap-4">
          <div class="btn btn-info btn-square btn-lg">
            <IconifyIcon icon="material-symbols:lan" class="text-2xl" />
          </div>
          <div>
      ...
      <div v-if="showCreateForm" class="border-t border-white/20">
        <div class="p-6 space-y-6">
          ...
          <div class="flex justify-end gap-3 pt-2">
            <button @click="showCreateForm = false" class="btn btn-ghost">
              <IconifyIcon icon="material-symbols:close" class="text-lg" />
              Annulla
            </button>
            <button @click="createNet" class="btn btn-primary">
    ...
    <div>
      ...
      <div v-if="nets.length === 0" class="liquid-glass-card-no-scale p-8 text-center">
        <IconifyIcon icon="material-symbols:wifi-off" class="text-6xl text-base-content/30 mb-4" />
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-6">
              ...
              <div class="flex items-center gap-3">
                ...
                >
                  <IconifyIcon :icon="getStatusIcon(net.status)" class="text-xl" />
                </div>
                <div>
                  ...
                  <span
                    ...
                    :class="getStatusColor(net.status)"
                  >
                    {{ net.status }}
                  </span>
                </div>
              ...
              <div class="hidden md:flex items-center gap-6">
                ...
                <div class="text-center">
                  ...
                  <div class="flex items-center justify-center">
                    <Icon
                      :icon="
                        net.vlanaware ? 'material-symbols:check-circle' : 'material-symbols:cancel'
                      "
