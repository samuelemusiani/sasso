  ...
  <div class="space-y-8">
    ...
    <div class="text-center">
      <h1 class="text-4xl font-bold text-base-content mb-2">
        <IconifyIcon icon="material-symbols:key" class="inline mr-3 text-primary" />
        Gestione Chiavi SSH
      </h1>
      <p class="text-base-content/70 text-lg">
        Gestisci le tue chiavi SSH per l'accesso sicuro ai server
      </p>
    </div>
      ...
      <div class="liquid-glass-card p-6">
        <div class="flex items-center gap-4">
          <div class="btn btn-primary btn-square btn-lg">
            <IconifyIcon icon="material-symbols:key" class="text-2xl" />
          </div>
          <div>
    ...
    <div class="liquid-glass-card">
      <div class="card-body p-6">
        <h2 class="card-title text-base-content mb-6 flex items-center gap-3">
          <IconifyIcon icon="material-symbols:add-circle" class="text-primary text-2xl" />
        ...
        <div class="card-actions justify-end">
          <button @click="addSSHKey()" class="btn btn-primary gap-2">
    ...
    <div v-else-if="keys.length === 0" class="text-center py-12">
      <div class="liquid-glass-card p-8">
        ...
        <p class="text-base-content/70">
          Aggiungi la tua prima chiave SSH per iniziare con l'accesso sicuro ai server.
        </p>
      </div>
    </div>
        ...
        <div class="card-body p-6">
          ...
          <div class="mt-4 flex items-center text-xs text-base-content/60">
            <span class="flex items-center gap-1">
              <IconifyIcon icon="material-symbols:security" class="text-sm" />
